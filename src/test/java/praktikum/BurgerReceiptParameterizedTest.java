...
public class BurgerReceiptParameterizedTest extends BaseTest {
    ...
    @Parameters(name = "Р§РµРє РґР»СЏ Р±СѓСЂРіРµСЂР° СЃ Р±СѓР»РѕС‡РєРѕР№ '{0}' Рё РёРЅРіСЂРµРґРёРµРЅС‚Р°РјРё {1}")
    ...
    public void testGetReceipt() {
        ...
        System.out.println("РћР–РР”РђР•РњР«Р™ Р§Р•Рљ:\n" + expectedReceipt);
        System.out.println("Р¤РђРљРўРР§Р•РЎРљРР™ Р§Р•Рљ:\n" + normalizedActual);
